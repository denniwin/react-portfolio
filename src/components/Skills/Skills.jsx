                ...
                <div className="mt-12">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        {skills.map((skill) => (
                                ...
                                <div className="relative transition-all cursor-pointer rounded-lg flex items-center space-x-3 px-6 py-5 bg-gray-800 shadow-sm hover:bg-gradient-to-r hover:from-indigo-900 hover:scale-105 hover:via-sky-800 hover:to-purple-900 focus:outline-none focus:ring-2 focus:ring-indigo-500">
